        ...
        return f'''<!doctype html>
                        <html lang="en">
                          <head>
                            ...
                            <link rel="stylesheet" type="text/css" href="{url_for('static', filename='css/astronauts_selection_style.css')}" />
                                ...
                                <form class="login_form" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="researcher" name="researcher">
                                        ...
                                        <div class="form-group form-check">
                                            ...
                                            <label class="form-check-label" for="doctor">Доктор</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
